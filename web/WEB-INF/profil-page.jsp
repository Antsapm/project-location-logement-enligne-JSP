...
<head>
  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
                                                                ...
                                                                <div class="col-md-12 col-xl-12">
                                                                    <c:choose>
                                                                        <c:when test="${not empty userloged[0]['photo']}">
                                                                            <img style="width: 20%; border-radius: 50%;"  src="assets/images/profil/<c:out value="${userloged[0]['photo']}"/>" id="photo_Prof" alt="User-Profile-Image">
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <img style="width: 20%; border-radius: 50%;"  src="assets/images/profil/user.png" id="photo_Prof" alt="User-Profile-Image">
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                    <div class="d-inline-block m-l-20">
                                                                        <div class="row">
                                                                            <span class="col-md-12">
                                                                                <label style="font-weight: bold; font-size: 180%; color:rgb(105, 0, 100);" id="pseudo_Prof"><c:out value="${userloged[0]['pseudo']}"/></label>
                                                                                <br>Actif
                                                                                <br> <button class="btn btn-md btn-primary" id="bntEdit" ><i class="ti-pencil">Modifier</i></button>
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="card-block accordion-block">
                                                                        <div class="pcoded-search">
                                                                            ...
                                                                            <div class="pcoded-search-box ">
                                                                                <input class="form-control form-control-round" id="contenu" placeholder="commentez............" type="text" placeholder="Search">
        ...
        <%@include file="./includes/modifUserModal.jsp" %>
...
<script>
    $(document).ready(function(){
        ...
        if ((userloged) && (userloged.userSession.length !== 0)){
                swal("Chargement...", {
                    buttons:false,
                    timer: 2000
                });
                // page titre............. 
                $('#titre').append(userloged.userSession[0]["pseudo"]);
                
                //$('#photo_Prof').attr('src', 'assets/images/profil/'+userloged.userSession[0]["photo"]);
                //$('#pseudo_Prof').append(userloged.userSession[0]['pseudo']);
                // dans le modal.... SET MODAL CONTENT............................
                $('#ipsudonyme').attr('value','');
                $('#i_id').attr('value','');

                $('#imdps').attr('value','');

                
                $('#modalTitre').append(userloged.userSession[0]["pseudo"]);
                $('#ipsudonyme').attr('value',userloged.userSession[0]["pseudo"]);
                $('#i_id').attr('value',userloged.userSession[0]["id"]);

                $('#imdps').attr('value',userloged.userSession[0]["password"]);

                $('#iname').attr('value',userloged.userSession[0]["nom_util"] + userloged.userSession[0]["prenom_util"]);
                $('#iaddress').attr('value',userloged.userSession[0]["adresse"]);
                //var actu = '<%= request.getAttribute("pub")%>';
        ...
        <script src="./assets/js/myapps/editUser.js"></script>
